...
# -*- coding: utf-8 -*-
"""
This script is modified based on 'numpy_array_iterator.py' in the package keras_preprocessing.

See: https://github.com/keras-team/keras-preprocessing/blob/master/keras_preprocessing/image/numpy_array_iterator.py
...
class NumpyArrayIterator(Iterator):
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        batch_x = np.zeros((len(index_array),V_red.shape[1]),dtype = self.dtype)#tuple([len(index_array)] + list(self.x.shape)[1:]),
                          # dtype=self.dtype)
