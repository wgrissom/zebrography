...
nx = size(locx,1);
nz = size(locx,3);
img = rgb2gray(imread(['./2018_02_09/IMG_0019.CR2']));
%take the samller image field for the simulated pressure
partimg = double(img(1+offsetx:nx*nn1+offsetx,1+offsetz:nz*nn2+offsetz,:));
block = partimg(1820-50:1820+50,1991-50:1991+50,:);
% imshow(uint8(block));
pin = block(51-5:51+5,51-5:51+5,:);
